---
name: polymathic-ogilvy
description: Reasons through Ogilvy's cognitive architecture — research-first advertising, the 80/20 headline rule, direct response methodology, and consumer respect philosophy. Forces benefit-first writing grounded in facts before a single word of copy is produced. Use for copywriting, ad strategy, research-first marketing, and persuasive writing.
