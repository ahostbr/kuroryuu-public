...
description: "Use when the user wants to toggle question mode — making Claude ask clarifying questions before making edits. Triggers on 'question_toggle', 'toggle questions', 'ask me before editing', 'stop asking questions', or when the user wants to control whether Claude asks for confirmation before changes."
---
