...
"""
Anthropic LLM Utilities for Kuroryuu

Ported from claude-code-hooks-mastery.

Provides fast LLM prompting using Anthropic's Haiku model.
Used for generating agent names, completion messages, and quick summaries.

Usage:
  uv run anth.py "your prompt here"
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Anthropic LLM Utilities for Kuroryuu")
        print("=" * 40)
        print("Usage:")
        print("  uv run anth.py 'your prompt here'")
        print("  uv run anth.py --completion")
        print("  uv run anth.py --agent-name")
