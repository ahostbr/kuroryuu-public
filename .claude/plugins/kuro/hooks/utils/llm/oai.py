...
"""
OpenAI LLM Utilities for Kuroryuu

Ported from claude-code-hooks-mastery.

Provides fast LLM prompting using OpenAI's fastest models.
Used for generating agent names, completion messages, and quick summaries.

Usage:
  uv run oai.py "your prompt here"
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("OpenAI LLM Utilities for Kuroryuu")
        print("=" * 40)
        print("Usage:")
        print("  uv run oai.py 'your prompt here'")
        print("  uv run oai.py --completion")
        print("  uv run oai.py --agent-name")
