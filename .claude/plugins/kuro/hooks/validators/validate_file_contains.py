...
Ported from claude-code-hooks-mastery for Kuroryuu.
...
Usage:
  uv run validate_file_contains.py -d Docs/Plans -e .md --contains "## Team Orchestration" --contains "## Step by Step Tasks"
...
Frontmatter example:
  hooks:
    Stop:
      - hooks:
          - type: command
            command: "uv run ${CLAUDE_PLUGIN_ROOT}/hooks/validators/validate_file_contains.py -d Docs/Plans -e .md --contains '## Team Orchestration'"
"""
...
# Constants - adjusted for Kuroryuu
