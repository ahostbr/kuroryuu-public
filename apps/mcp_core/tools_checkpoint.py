...
def _action_help(**kwargs: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "data": {
            ...
            "actions": {
                "help": "Show this help",
                "save": "Save checkpoint. Params: name (required), data (required), summary, tags",
...
def k_checkpoint(
    ...
    **kwargs: Any,
    ...
    Routed tool with actions: help, save, list, load
...
def register_checkpoint_tools(registry: "ToolRegistry") -> None:
    ...
    registry.register(
        name="k_checkpoint",
        description="Session/thread persistence. Actions: help, save, list, load",
        input_schema={
            "type": "object",
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["help", "save", "list", "load"],
