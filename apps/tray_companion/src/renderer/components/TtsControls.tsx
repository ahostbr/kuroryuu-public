...
import { Settings, RefreshCw, Play, Key, Trash2, Clipboard } from 'lucide-react';
...
function TtsControls({ settings, onUpdateSettings }: TtsControlsProps): React.JSX.Element {
  ...
  return (
    <div className="tts-three-col">
      {/* Column 1: Engine Selector */}
      <div className="tts-col-engine">
        <h2 className="shrine-header">
          <div className="header-icon-shrine">
            <Settings />
          </div>
          <span className="header-text">Engine</span>
        </h2>
      ...
      {/* Column 2: Engine Configuration */}
      <div className="tts-col-config">
      ...
      {/* Column 3: Auto-speak */}
      <div className="tts-col-autospeak">
        <h2 className="shrine-header">
          <div className="header-icon-shrine">
            <Clipboard />
          </div>
        ...
        <div className="content-card p-5 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onUpdateSettings({ maxChars: parseInt(e.target.value) })}
              className="w-full"
            />
            <div className="flex justify-between text-xs mt-1" style={{ color: 'var(--text-muted)' }}>
              <span>50</span>
